...
function ChatArea() {
    ...
    // Selectors
    const { currentRoom: room } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "ChatArea.useAppSelector": (state)=>state.rooms
    }["ChatArea.useAppSelector"]);
    const { messages, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "ChatArea.useAppSelector": (state)=>state.messages
    }["ChatArea.useAppSelector"]);
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "ChatArea.useAppSelector": (state)=>state.auth
    }["ChatArea.useAppSelector"]);
    ...
    const handleSend = async ()=>{
        if (!inputText.trim() && !selectedFile || !room || !currentUser) return;
        setSending(true);
        try {
            let type = "TEXT";
            let fileId;
...
_s(ChatArea, "aZnS47oQmugdMg0NgYt6KTnlvzQ=", false, function() {
    return [
...
function RoomPage({ params }) {
    ...
    const dispatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppDispatch"])();
    // Redux State
    const { user, session, loading: authLoading, initialized: authInitialized } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "RoomPage.useAppSelector": (state)=>state.auth
    }["RoomPage.useAppSelector"]);
    const { currentRoom: room, members } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "RoomPage.useAppSelector": (state)=>state.rooms
    }["RoomPage.useAppSelector"]);
    const { messages } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "RoomPage.useAppSelector": (state)=>state.messages
    }["RoomPage.useAppSelector"]);
    // Initial Auth Check
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoomPage.useEffect": ()=>{
            if (!authInitialized) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkSession"])());
            }
        }
    }["RoomPage.useEffect"], [
        dispatch,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoomPage.useEffect": ()=>{
            if (roomId && session) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$roomSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enterRoom"])(roomId));
    ...
    const handleCloseRoom = async ()=>{
        ...
        if (confirm("Are you sure you want to close this room? It will be read-only.")) {
            try {
                ...
                // Refresh room state
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$roomSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enterRoom"])(room.$id));
            } catch (e) {
                console.error(e);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$room$2f$ChatArea$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/src/app/(rooms)/room/[roomId]/page.tsx",
                lineNumber: 87,
                columnNumber: 13
            }, this),
...
_s(RoomPage, "V/B/WUxxDsVXc1gkQ1+oHBNmoVc=", false, function() {
    return [
...
//# sourceMappingURL=src_1a835544._.js.map