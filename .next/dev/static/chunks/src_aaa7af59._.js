...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$roomSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/slices/roomSlice.ts [app-client] (ecmascript)"); // fetchRooms used for refresh context if needed
...
function RoomPage({ params }) {
    ...
    const { currentRoom: room, members, loading: roomLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "RoomPage.useAppSelector": (state)=>state.rooms
    }["RoomPage.useAppSelector"]);
    const { messages, loading: messagesLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
    ...
    const handleSendMessage = async (content, type, file)=>{
        ...
        // Use Redux action
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$messageSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendMessage"])(payload));
    };
...
_s(RoomPage, "qfQJUVq86uvXfOoAoUDPEFCUaDM=", false, function() {
    return [
...
//# sourceMappingURL=src_aaa7af59._.js.map